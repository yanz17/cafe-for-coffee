...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <?php if(Route::has('register')): ?>
                <a class="ms-4 underline text-sm text-indigo-600 hover:text-indigo-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<?php echo e(route('register')); ?>">
                    <?php echo e(__('Belum punya akun? Register')); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\cafe-for-coffee\resources\views/auth/login.blade.php ENDPATH**/ ?>