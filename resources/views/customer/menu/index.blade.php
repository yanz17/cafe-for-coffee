                    ...
                    <div class="bg-white shadow-xl sm:rounded-lg p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            @foreach ($menus as $menu)
                                ...
                                <div x-show="isMenuVisible('{{ $safeName }}', searchTerm)" 
                                     @click="{{ $isAvailable ? 'addItem('. $menu->id .', ' . $safeName . ', '. $menu->harga .', '. $maxStok .')' : 'alert(\'Mohon maaf, stok sudah habis.\')' }}"
