                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="harga" id="harga" 
                                    class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" 
                                    required min="0" value="{{ old('harga', $menu->harga) }}">
                            ...
                            <div>
                                ...
                                <textarea name="deskripsi" id="deskripsi" rows="3" 
                                    class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('deskripsi', $menu->deskripsi) }}</textarea>
                            ...
                            <div>
                                ...
                                @if ($menu->foto)
                                    <img src="{{ asset('storage/' . $menu->foto) }}" alt="{{ $menu->nama }}" class="h-24 w-24 object-cover my-2 rounded-lg border">
                            ...
                            <div class="pt-4">
                                <label for="is_tersedia" class="inline-flex relative items-center cursor-pointer">
                                    ...
                                    <input type="checkbox" name="is_tersedia" id="is_tersedia" value="1" 
                                           class="sr-only peer" {{ old('is_tersedia', $menu->is_tersedia) ? 'checked' : '' }}>
